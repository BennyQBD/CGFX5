...
{
	static inline void intersectPlaneAABBFast(const Vector& center, const Vector& extents, 
	...
	static inline bool intersectPlaneAABB(const AABB& aabb, const Plane& plane, bool& isFullyInside, bool& isPartiallyInside)
	{
	...
	static inline bool intersectPlaneAABB(const AABB& aabb, const Plane& plane)
	{
		bool isFullyInside;
	...
	static inline void intersectPlaneSphereFast(const Vector& center, float radius, const Plane& plane, bool& isFullyInside, bool& isPartiallyInside)
	{
	...
	static inline bool intersectPlaneSphere(const Sphere& sphere, const Plane& plane, bool& isFullyInside, bool& isPartiallyInside)
	{
		intersectPlaneSphereFast(sphere.getCenter().toVector(1.0f), sphere.getRadius(), plane, isFullyInside, isPartiallyInside);
		return isPartiallyInside && !isFullyInside; 
	}

	static inline bool intersectPlaneSphere(const Sphere& sphere, const Plane& plane)
	{
		bool isFullyInside;
		bool isPartiallyInside;
	...
	static inline bool intersectSphereAABBFast(const Vector& sphereCenter, const Vector& aabbMins, const Vector& aabbMaxs, float radiusSq)
	{
		Vector result =
	...
	static inline bool intersectSphereAABB(const Sphere& sphere, const AABB& aabb)
	{
